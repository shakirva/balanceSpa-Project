...
const LanguageSelection = () => {
  ...
  const handleLanguageSelect = (languageCode) => {
    ...
    navigate('/menu', { state: { language: languageCode } });
  };
    ...
    <div className="min-h-screen bg-black flex items-center justify-center py-12 px-4">
      <div className="flex flex-col items-center justify-center w-full max-w-lg mx-auto">
        ...
        <img 
          ...
          className="w-48"
        />
        <h1 className="text-white text-3xl font-bold mb-4 capitalize -mt-6">BALANCE SPA</h1>
        <h2 className=" mt-0 pt-0 mb-6 text-center text-md text-[#9CA3AF]">Select Your Language</h2>
        <div className="flex justify-center gap-[4px] space-x-8 w-full">
          {languages.map((language) => (
            <button
              ...
              className={`
                ...
                border
                border-white]
                ${selectedLanguage === language.code ? 'border-1 ' : ''}
              `}
